  ...
  return (
    <>
      <Splide options={options} onMoved={() => updatePaginationDots()} ref={splideRef} aria-labelledby="My Favorite Images">
        <SplideSlide className='block p-3 font-[Sora]'>
          ...
          <section className='min-w-full min-h-[100vh]'>
            ...
            <div className='flex portrait:flex-col landscape:flex-row landscape:justify-center lg:landscape:justify-between portrait:flex-wrap landscape:flex-wrap lg:landscape:flex-nowrap items-center landscape:py-5 portrait:py-0'>
...
export default SliderForTouchscreen